 ...
 * ```javascript
 *
 * var uri = new URI('flo:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('flo:12A1MyfXbW6RhdRAZEqofac5jCQQjwEPBu');
 * // true
 * ```
 *
 * @param {string|Object} data - A florincoin URI string or an Object
...
/**
 * Internal function to transform a FLO string amount into satoshis
 *
 * @param {string} amount - Amount FLO string
 * @throws {TypeError} Invalid amount
...
URI.prototype._parseAmount = function(amount) {
  ...
  return Unit.fromFLO(amount).toSatoshis();
};
...
URI.prototype.toString = function() {
  var query = {};
  if (this.amount) {
    query.amount = Unit.fromSatoshis(this.amount).toFLO();
  }
  if (this.message) {
