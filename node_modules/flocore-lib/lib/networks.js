...
function get(arg, keys) {
  ...
  if (Array.isArray(networkMaps[arg])){
    return networkMaps[arg][networkMaps[arg].length - 1]
  }
...
var TESTNET = {
  PORT: 17312,
  NETWORK_MAGIC: BufferUtil.integerAsBuffer(0xfdc05af2),
  DNS_SEEDS: [
    'testnet.oip.fun'
  ]
};
