# Public Key
Represents a florincoin public key and is needed to be able to receive florincoin, as is usually represented as a florincoin [Address](address.md). See the official [Florincoin Wiki](https://en.florincoin.it/wiki/Technical_background_of_version_1_Florincoin_addresses).
...
A public key point should be on the [secp256k1](https://en.florincoin.it/wiki/Secp256k1) curve, instantiating a new PublicKey will validate this and will throw an error if it's invalid. To check that a public key is valid:
